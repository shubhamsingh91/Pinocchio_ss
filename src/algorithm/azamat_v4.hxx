...
#ifndef __pinocchio_azamat_v4_hxx__
#define __pinocchio_azamat_v4_hxx__
...
namespace pinocchio
{
  ...
  struct azamat_v4ForwardStep1
  : public fusion::JointUnaryVisitorBase< azamat_v4ForwardStep1<Scalar,Options,JointCollectionTpl,ConfigVectorType> >
  {
  ...
  struct azamat_v4BackwardStep
  : public fusion::JointUnaryVisitorBase< azamat_v4BackwardStep<Scalar,Options,JointCollectionTpl> >
  {
    typedef ModelTpl<Scalar,Options,JointCollectionTpl> Model;
    typedef DataTpl<Scalar,Options,JointCollectionTpl> Data;
    ...
    //   std::cout <<"Fcrb here in second loop is" << Fcrb << std:: endl;
     ...
     //-- First line    
       ...
       // std::cout << "Fcrb middle cols here is"<<Fcrb.middleCols(0,2*model.nv) << std::endl;
        ...
        if(parent > 0)
            data.Yaba[parent] += internal::SE3actOn_azamat_v4<Scalar>::run(data.liMi[i], Ia);
  ...
  template<typename Scalar, int Options, template<typename,int> class JointCollectionTpl>
  struct azamat_v4ForwardStep2
  : public fusion::JointUnaryVisitorBase< azamat_v4ForwardStep2<Scalar,Options,JointCollectionTpl> >
  {
    typedef ModelTpl<Scalar,Options,JointCollectionTpl> Model;
    typedef DataTpl<Scalar,Options,JointCollectionTpl> Data;
...

  {
    ...
    typedef azamat_v4ForwardStep1<Scalar,Options,JointCollectionTpl,ConfigVectorType> Pass1;
    ...
    typedef azamat_v4BackwardStep<Scalar,Options,JointCollectionTpl> Pass2;
    ...
    typedef azamat_v4ForwardStep2<Scalar,Options,JointCollectionTpl> Pass3;
    for(JointIndex i=1; i<(JointIndex)model.njoints; ++i)
    {
