...
int main(int argc, const char ** argv)
{
  ...
  const int NBT = 1; // 50000 initially
   ...
   // str_int = 0; // integer to change the str_urdf
    ...
    str_urdf[4] = "/home/ss86299/Desktop/test_pinocchio/pinocchio/models/anymal.urdf"; // anymal
    str_urdf[5] = "/home/ss86299/Desktop/test_pinocchio/pinocchio/models/atlas.urdf"; //atlas
...
//-------------------------------------------------//
 ...
 timer.tic();
  ...
  std::cout << "FD partial using AZA_mat timing is = \t\t"; timer.toc(std::cout,NBT);
